...
ActiveRecord::Schema.define(version: 2021_10_07_032322) do
  ...
  create_table "address_lists", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["shopping_list_id"], name: "index_address_lists_on_shopping_list_id"
  end
  ...
  add_foreign_key "address_lists", "shopping_lists"
