class ShoppingListAddressList
  ...
  attr_accessor :user_id, :item_id, :post_num, :todouhuken_id, :city, :house_num, :building_name, :tel_num, :shopping_list_id,
                :token
  ...
  def save
    ...
    AddressList.create(post_num: post_num, todouhuken_id: todouhuken_id, city: city, house_num: house_num,
                       building_name: building_name, tel_num: tel_num, shopping_list_id: shopping_list.id)
  end
end
