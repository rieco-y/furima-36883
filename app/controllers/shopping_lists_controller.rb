class ShoppingListsController < ApplicationController
  ...
  def shopping_list_params
    ...
    params.require(:shopping_list_address_list).permit(:user_id, :item_id, :post_num, :todouhuken_id, :city, :house_num, :building_name, :tel_num, :shopping_list_id).merge(user_id: current_user.id, item_id: params[:item_id], token: params[:token])
  end
